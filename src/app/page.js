  ...
  return (
    <div className="w-full overflow-x-hidden min-h-screen grid lg:grid-cols-[1fr_0.6fr_0.4fr] gap-[20px]">
      ...
      <div className="max-w-[600px] w-[90%] mx-auto py-8">
        <a href="/" className="font-bold text-amber-50"> <Image src={logo} width={120} height={80} className="max-h-[80px] h-full object-contain object-center" alt="logo" /></a>
        {/* left side content  */}
        <div className="flex flex-col justify-center h-[80%]">
          ...
          <a href="#" className=" text-white  border-[#525252] border-b hover:p-[10px] hover:bg-[#5070ff2f] mr-auto text-start ease-in-out duration-200 py-2 hover:px-5 hover:rounded-full cursor-pointer">
            Contact Me &rarr;
          </a>
        </div>
      ...
      <div className="w-[90%] mx-auto py-10 flex flex-col items-center z-3">
        <a href="#" className="max-w-32 w-full h-[35px] flex justify-center items-center  border-1 border-[#525252] mx-auto pb-1 rounded-4xl">Hire me</a>
        ...
        <p className="max-w-xl mx-auto text-sm md:text-md text-neutral-700 dark:text-neutral-400 text-start ">
          ...
          I'm proficient in JavaScript (ES6+), with solid knowledge of HTML5 and CSS3, and I often use Tailwind CSS to rapidly create modern, utility-first UI designs. For animations and motion effects, I rely on Framer Motion to bring interfaces to life with smooth transitions.
          ...
          In terms of tooling, I'm experienced with Git and GitHub for version control, and I use VS Code as my primary development environment. I'm also familiar with npm and pnpm for managing project dependencies.
